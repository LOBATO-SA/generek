...
const StyledWrapper = styled.div`
  ...
  .icon-1 {
    ...
    width: 50px;
    height: auto;
    animation: plantGrow1 2s ease forwards, plantSway1 3s ease-in-out infinite 2s;
  ...
  .icon-2 {
    ...
    width: 75px;
    height: auto;
    animation: plantGrow2 2.2s ease 0.2s forwards, plantSway2 3.5s ease-in-out infinite 2.2s;
    transform-origin: 0 100%;
    opacity: 0;
  }
  ...
  .icon-3 {
    ...
    width: 60px;
    height: auto;
    animation: plantGrow3 2.1s ease 0.4s forwards, plantSway3 3.2s ease-in-out infinite 2.5s;
    transform-origin: 0 100%;
    opacity: 0;
  }
  ...
  .icon-4 {
    ...
    width: 85px;
    height: auto;
    animation: plantGrow4 2.3s ease 0.6s forwards, plantSway4 3.8s ease-in-out infinite 2.9s;
    transform-origin: 0 100%;
    opacity: 0;
  }
  ...
  .icon-5 {
    ...
    width: 85px;
    height: auto;
    animation: plantGrow5 2.4s ease 0.8s forwards, plantSway5 4s ease-in-out infinite 3.2s;
    transform-origin: 0 100%;
    opacity: 0;
  }

  @keyframes plantGrow1 {
    0% {
      opacity: 0;
